...
% xdc_linear_array (N_elements, width, element_height, kerf, no_sub_x, no_sub_y, focus);
...
for i=1:no_lines
    ...
    xdc_dynamic_focus (receive_aperture, 0, [x 0 z_focus]);
